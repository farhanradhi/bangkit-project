...
public final class ActivityCameraBinding implements ViewBinding {
  ...
  @NonNull
  public final ImageView scanningLine;
  ...
  private ActivityCameraBinding(@NonNull ConstraintLayout rootView, @NonNull ImageView captureImage,
      @NonNull ImageView scanningLine, @NonNull ImageView switchCamera,
      @NonNull PreviewView viewFinder) {
    this.rootView = rootView;
    this.captureImage = captureImage;
    this.scanningLine = scanningLine;
  ...
  public static ActivityCameraBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      id = R.id.scanningLine;
      ImageView scanningLine = ViewBindings.findChildViewById(rootView, id);
      ...
      return new ActivityCameraBinding((ConstraintLayout) rootView, captureImage, scanningLine,
