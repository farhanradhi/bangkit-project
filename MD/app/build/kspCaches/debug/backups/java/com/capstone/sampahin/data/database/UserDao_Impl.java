...
public final class UserDao_Impl implements UserDao {
  ...
  public UserDao_Impl(RoomDatabase __db) {
    ...
    this.__insertionAdapterOfUserEntity = new EntityInsertionAdapter<UserEntity>(__db) {
      ...
      public String createQuery() {
        return "INSERT OR REPLACE INTO `users` (`token`,`name`,`email`) VALUES (?,?,?)";
      }
  ...
  @Override
  public Object insertUser(final UserEntity stories,
    ...
    return CoroutinesRoom.execute(__db, true, new Callable<Unit>() {
      ...
      public Unit call() throws Exception {
        ...
        try {
          __insertionAdapterOfUserEntity.insert(stories);
  ...
  @Override
  public Object getUserByUid(final String token,
      final Continuation<? super UserEntity> continuation) {
    final String _sql = "SELECT * FROM users WHERE token = ? LIMIT 1";
      ...
      public UserEntity call() throws Exception {
        ...
        try {
          ...
          if(_cursor.moveToFirst()) {
            ...
            _result = new UserEntity(_tmpToken,_tmpName,_tmpEmail);
          } else {
            _result = null;
          }
          return _result;
